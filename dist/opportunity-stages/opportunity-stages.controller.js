...
let OpportunityStagesController = class OpportunityStagesController {
    ...
    constructor(opportunityStagesService) {
        this.opportunityStagesService = opportunityStagesService;
    }
    create(dto) {
...
], OpportunityStagesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], OpportunityStagesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], OpportunityStagesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], OpportunityStagesController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], OpportunityStagesController.prototype, "remove", null);
